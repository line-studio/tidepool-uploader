...
module.exports = {
  ...
  API_URL: process.env.API_URL || 'https://dev-us.tdpl.dk',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://dev-us.tdpl.dk',
  DATA_URL: process.env.DATA_URL || 'https://dev-us.tdpl.dk/dataservices',
  BLIP_URL: process.env.BLIP_URL || 'https://dev-us.tdpl.dk',
  DEFAULT_TIMEZONE: process.env.DEFAULT_TIMEZONE || 'Europe/Copenhagen',
