...
module.exports = {
  ...
  API_URL: process.env.API_URL || 'https://steno.tdpl.dk',
  UPLOAD_URL: process.env.UPLOAD_URL || 'https://steno.tdpl.dk',
  DATA_URL: process.env.DATA_URL || 'https://steno.tdpl.dk/dataservices',
  BLIP_URL: process.env.BLIP_URL || 'https://steno.tdpl.dk',
